...
class BedBathingPlusJacoEnv(BedBathingPlusEnv):
    def __init__(self):
        super(BedBathingPlusJacoEnv, self).__init__(robot=Jaco(robot_arm), human=Human(human_controllable_joint_indices, controllable=False))
